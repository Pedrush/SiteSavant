...
from services.embeddings_indexer import (
    replace_or_create_pinecone_index,
    process_metadata,
    prepare_upsert_data,
    batch_upsert,
    index_records,
...
@pytest.mark.parametrize(
    "existing_index,expected_call_count", [(False, 1), (True, 2)]  # One for delete, one for create
)
def test_replace_or_create_pinecone_index(
    mock_pinecone, mock_logging, existing_index, expected_call_count
):
